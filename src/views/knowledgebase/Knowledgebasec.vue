<template>
  ...
  <el-row style="width: 100%;height:100%;">
    ...
    <div style="margin:20px 0;">
      ...
      <el-button type="primary" @click="add" style="margin-left:400px;" size="normal">新增</el-button>
      <!-- <div style="flex"></div> -->
      <el-button type="primary" style="margin-left:20px;" @click="load()" plain size="normal">查询全部</el-button>
    </div>
    <el-table :data="tableData" stripe style="width: 100%;margin-top:20px;font-size:14px; font-weight:bold;color:#8b7042;">
      <el-table-column prop="id" label="编码" width="60" />
  ...
  <el-col :span="12">
    ...
    <div style="margin:20px 0;">
      ...
      <el-button type="primary" @click="add" style="margin-left:450px;" size="normal">上传</el-button>
      <!-- <div style="flex"></div> -->
      <el-button type="primary" style="margin-left:20px;" @click="load()" plain size="normal">查询全部</el-button>
    </div>
    <el-table :data="tableData2" stripe style="width: 100%;margin-top:20px;font-size:14px; font-weight:bold;color:#8b7042;">
