<template>
  ...
  <el-row style="width: 100%;height: calc( 100% );">
    ...
    <el-table :data="tableData" stripe style="width: 100%;margin-top:20px;font-size:14px; font-weight:bold;color:#8b7042;" max-height="470">
  ...
  <el-col :span="12">
    ...
    <el-table :data="tableData2" stripe style="width: 100%;margin-top:20px;font-size:14px; font-weight:bold;color:#8b7042;" max-height="450">
      ...
      <el-table-column prop="title" label="标题" width="120">
       ...
       <!-- <el-table-column prop="status" label="状态" width="60" /> -->
      <el-table-column prop="content" label="正文" width="350">
        <template #default="scope">
...
export default {
  ...
  methods: {
    async loadid1() {
      ...
      try{
        await  request.get("/knowledgebase/"+this.userStore.user+"/"+code1).then(res => {
    ...
    async loadid2() {
      ...
      try{
        await  request.get("/knowledge/"+this.kbid+"/"+code2+"/"+keyword2).then(res => {
    ...
    async save1() {
      ...
      if (this.createp === 1) {
        // console.log(this.form);
        try{
          this.form.userId=this.userStore.user
